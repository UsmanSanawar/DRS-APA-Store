...
class InputNumber extends Component {
  ...
  change(direction) {
    ...
    let newValue =
      (value === "" || Number.isNaN(value) ? 0 : value) + step * direction;
  ...
  render() {
    const { size, className, ...otherProps } = this.props;
    ...
    return (
      <div className={classes}>
        ...
        <div
          ...
          onMouseDown={
            this.props.optionQuantity
              ? this.props.optionQuantity > this.props.stateQuantity
                ? () => this.handleAddMouseDown()
                : null
              : this.props.productQuantity > this.props.stateQuantity
              ? () => this.handleAddMouseDown()
              : null
          }
        />
