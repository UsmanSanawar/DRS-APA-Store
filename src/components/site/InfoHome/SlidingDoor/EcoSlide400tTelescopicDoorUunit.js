...
import ES400T_Track_Cover from "../../../../assets/imgs/ES400T-Track-Cover-1024x482.png";
import {Helmet} from "react-helmet/es/Helmet";
import theme from "../../../../data/theme";


class EcoSlide400TTelescopicDoorUunit extends Component {
    render() {
        return (
            <div>
                <Helmet>
                ...
                <div className="container">
                    <h2 className={"my-5"}>Eco-Slide 400T Telescopic Door Unit</h2>
                    ...
                    <div>
                        <p className="my-3">Compact Operator housing with lift off cover & opening interlock c/w Cover Stay   100mm high   x  245mm  wide</p>
                        ...
                        <p className="my-3">We also developed a “2 part system” which uses a secondary track and this is coupled to a standard ES400 sliding door operator. This makes it very easy to install as the secondary track is fitted first along with the secondary door leaves. Only then is the standard operator fitted and then connected.</p>
                        <p className="my-3">All our sliding door operators throughout the range have comment components.</p>
                    </div>

                    <div className="text-center my-4">
                        <img height={485} src={ES400T_Track_Cover} alt="ES400T_Track_Cover"/>
                    </div>
...
export default EcoSlide400TTelescopicDoorUunit;
