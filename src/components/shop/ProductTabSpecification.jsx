    ...
    <div className="spec">
      ...
      <div className="spec__section">
        ...
        <div className="spec__row">
          ...
          <div className="spec__value">{`${props.product.weight}  Kg`}</div>
        </div>
        ...
        <div className="spec__row">
          ...
          <div className="spec__value">{`${props.product.length ? props.product.length + "cm" : '-'}`}</div>
        </div>

        <div className="spec__row">
          <div className="spec__name">Width</div>
          <div className="spec__value">{`${props.product.width ? props.product.width + "cm" : '-'}`}</div>
        </div>

        <div className="spec__row">
          <div className="spec__name">Height</div>
          <div className="spec__value">{`${props.product.height ? props.product.height + "cm" : '-'}`}</div>
        </div>
