...
//    let currentUrl = "https://drsapa.ddns.net:2550/#" + location.pathname;
   let currentUrl = "http://77.68.93.42:90/#" + location.pathname;
...
"So, join us on this voyage, and explore the beauty and miracle of being yourself!";
   let hashtag = props.hashtag !== undefined ? props.hashtag : "#DRS-APA-Store";
return (
 <Helmet>
     <title>{title}</title>
     <meta charset="utf-8" />
     ...
     <meta property="og:site_name" content="DRS-APA" />
