    ...
    useEffect(()=> {
        RestService.getWebPageComponentByPageId(6).then(res => {
            if (res.data.status == "success") {
                console.log(res.data.data.sort((a,b) =>  a.order-b.order ))

                setComponents(res.data.data.sort((a,b) =>  a.order-b.order ))
            }
        })
    },[])
        ...
        <React.Fragment>
            ...
            <div className="container mt-2">
                    ...
                    <iframe
                        width="100%"
                        height="500px"
                        src="https://www.youtube.com/embed/YN5pl0b13QI"
                        frameBorder="0"
...
Automatic door
                    ...
                    <div className="col-lg-6">
                        <div style={{
                            backgroundImage: `url(${bg1})`, borderRadius: 20, marginBottom: 15, paddingLeft: 30, paddingTop: 30, verticalAlign: 'center', height: 200,
                        }}
                        >
                            <h4>Automatic</h4>
                            <h1 style={{ }}>DOOR SYSTEMS</h1>
                            <button style={{
                                backgroundColor: '#f1630c', borderRadius: 20, color: '#ffffff', border: 'none', width: 100, padding: 5,
                            }}
                            >
Browse
                            </button>
