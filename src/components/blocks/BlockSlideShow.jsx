        ...
        <div key={index} className="block-slideshow__slide">
          ...
          <div className="block-slideshow__slide-content">
            ...
            <div className="block-slideshow__slide-button">
              {carousal.showButton ?
                <Link to="/" style={{backgroundColor: `${carousal.buttonColor}`}}
                      className="btn btn-primary btn-lg border-0">{carousal.buttonText}</Link>
                : null
              }
            </div>
          ...
          <div className="container">
            <div className="row">
              ...
              <div className={layoutClasses}>
                <div className="block-slideshow__body conditionalWidth">
